...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        ...
        Stream<Person> stream = Stream.generate(() -> createRandomPerson()).limit(listSize);
    ...
    public Person[] createPersonArray(int arrayLength) {
        ...
        Stream<Person> stream = Stream.generate(() -> createRandomPerson()).limit(arrayLength);
        Person[] personArr = stream.toArray(Person[]::new);
    ...
    public Stream<Person> createPersonStream(int streamCount) {
        ...
        Stream<Person> stream = Stream.generate(() -> createRandomPerson()).limit(streamCount);
