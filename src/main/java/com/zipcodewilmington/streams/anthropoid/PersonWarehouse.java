...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public List<String> getNames() {
       ...
       people.stream().forEach(person -> peopleName.add(person.getName()));
    ...
    public Map<Long, String> getIdToNameMap() {
        ...
        people.stream().forEach(person -> personMap.put(person.getPersonalId(),person.getName()));
    ...
    public Stream<Stream<String>> getNestedAliases() {
       ...
       //Stream<String> streamStreamAliases =
             //  people.stream().filter(person -> person.getAliases());
